...
public class Adventures {
    ...
    public static TextAdventure getFiremanGame() throws TextAdventureException {
    	TextAdventure textAdventure = Factory.getGameF("Sample1", 6, 6);
        try {
        ...
        textAdventure.addTransformation("Bucket", "Lake", "Water", "Lake","Now you got a bucket full of water.");

        textAdventure.addTransformation("Water", "BurningTree", "HalfBurningTree", "Bucket","The water quenches the fire. But not completely.");
        textAdventure.addTransformation("Water", "HalfBurningTree", "CharredOak", "Bucket","The water quenches the fire.");
        ...
        textAdventure.placeItem("Headweh", 1, 1);

        textAdventure.placeItem("CharredOak", 3, 4);

        textAdventure.placeItem("Head", 1, 2);
        textAdventure.placeItem("BurningTree", 0, 2);
             }catch(Exception e) {
    ...
    public static TextAdventure getLumberjackGame() throws TextAdventureException {
        TextAdventure textAdventure = Factory.getGameF("Sample2", 1, 1);
        try {
    ...
    public static TextAdventure getPokemonGame() throws TextAdventureException {
        TextAdventure textAdventure = Factory.getGameF("Pokemon", 50, 50);
        try {
